...
const ProfileCard = React.memo(function ProfileCard({ icon, label, value, color = "#FFD700", gradient, borderColor, iconStyle }) {
  return (
    <div
      style={{
        textAlign: "center",
    ...
    >
      {icon && (
        <img
          src={icon}
          alt={label}
          style={{ width: "32px", height: "32px", marginBottom: "8px", ...iconStyle }}
        />
      )}

  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#D4AF37", marginBottom: 8 }}>
          Daily Quest 🌙
        </h2>

        <p style={{ fontSize: "0.9rem", lineHeight: 1.5, color: "#cbd5e1", marginBottom: 16 }}>
        ...
        >
          <p style={{ fontSize: "0.85rem", color: "#D4AF37", marginBottom: 6 }}>⭐ No timer - take your time</p>
          <p style={{ fontSize: "0.85rem", color: "#10B981", marginBottom: 6 }}>
            🪙 Rewards: <strong>+60 XP</strong> and <strong>+20 coins</strong>
          </p>
          <p style={{ fontSize: "0.85rem", color: "#94a3b8", margin: 0 }}>📅 One quest per day</p>
        </div>

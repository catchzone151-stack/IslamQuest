// Major Signs of the End Times Learning Path
...
const endTimesLessons = [
  {
    ...
    description: [
      "The Prophet ﷺ taught us about major signs that will appear before the Day of Judgment. These signs are clear warnings that the Hour is near and time is ending.",
...

  {
    ...
    title: "Imam Mahdi",
    description: [
      "The Mahdi will be a righteous leader from the Prophet's ﷺ ﷺ family who appears during a time of great oppression and injustice. His name will be Muhammad ﷺ ibn Abdullah like the Prophet ﷺ.",
  ...
  {
    id: 3,
    title: "Dajjāl (The False Messiah)",
    description: [
  ...
  {
    id: 4,
    title: "ʿĪsā ibn Maryam (Jesus)",
    description: [
      "Prophet ʿĪsā will descend from Heaven to a white minaret in Damascus while wearing two yellow garments. He will place his hands on angels' wings and descend during the time of Fajr prayer.",
      "ʿĪsā will pursue the Dajjāl and kill him at the gate of Lud in Palestine. When the Dajjāl sees ʿĪsā, he will melt like salt dissolves in water, but ʿĪsā will kill him with his spear.",
      "After defeating the Dajjāl, ʿĪsā will rule with justice according to Islamic law. He will break the cross, abolish the jizyah tax, and refuse all wealth. Peace and prosperity will spread across the earth."
    ],
    evidence: {
...

  {
    ...
    evidence: {
      arabic: "لَا تَقُومُ السَّاعَةُ حَتَّى تَطْلُعَ الشَّمْسُ مِنْ مَغْرِبِهَا، فَإِذَا طَلَعَتْ فَرَآهَا النَّاسُ آمَنُوا أَجْمَعُونَ، فَذَلِكَ حِينَ لَا يَنْفَعُ نَفْسًا إِيمَانُهَا لَمْ تَكُنْ آمَنَتْ مِنْ قَبْلُ",
...

  {
    ...
    evidence: {
      arabic: "لَا تَقُومُ السَّاعَةُ حَتَّى يُقْبَضَ الْعِلْمُ، وَتَكْثُرَ الزَّلَازِلُ، وَيَتَقَارَبَ الزَّمَانُ... وَحَتَّى يَكُونَ الْخَسْفُ: خَسْفٌ بِالْمَشْرِقِ، وَخَسْفٌ بِالْمَغْرِبِ، وَخَسْفٌ بِجَزِيرَةِ الْعَرَبِ",

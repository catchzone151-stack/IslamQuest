...
const graveLessons = [
  {
    ...
    title: "Death",
    description: [
      "Every soul will taste death at its appointed time. No one can delay or advance death even by a single moment. Allah ﷻ alone decides when each person's life will end.",
      ...
      "Remembering death frequently keeps our hearts focused on what truly matters. When we remember death often, we prioritize good deeds over worldly pleasures and prepare properly for our inevitable meeting with Allah ﷻ."
    ],
    evidence: {
...

  {
    ...
    description: [
      "Allah ﷻ assigned the Angel of Death and his helpers to take souls when their time comes. These angels know exactly when and where each person will die according to Allah ﷻ's perfect decree and divine wisdom.",
      "For believers, the angels come with beautiful faces and pleasant fragrance, gently extracting the soul like water flowing from a pitcher. They bring glad tidings of Allah ﷻ's mercy, Paradise, and eternal peace and happiness.",
      "For disbelievers, the angels come with harsh appearance and take the soul roughly like thorns tearing through wet wool. They bring warnings of Allah ﷻ's anger, Hellfire, and eternal punishment for their rejection and sins."
    ],
    evidence: {
...

  {
    ...
    description: [
      "After death, the believer's soul is taken up through the heavens. At each heaven's gate, the angels welcome it joyfully and open the gates. The soul ascends until it reaches Allah ﷻ's presence.",
...

  {
    ...
    description: [
      ...
      "The believer who lived with sincere faith answers confidently and correctly: My Lord is Allah ﷻ, my religion is Islam, and my Prophet is Muhammad ﷺ. The angels make the grave spacious, comfortable, and filled with light.",
    ...
    evidence: {
      ...
      translation: "Allah ﷻ keeps firm those who believe, with the firm word, in this worldly life and in the Hereafter.",
      source: "Qur'an 14:27"
    },
...

  {
    ...
    evidence: {
      ...
      translation: "Indeed, those who have said, 'Our Lord is Allah ﷻ' and then remained steadfast - the angels will descend upon them, saying, 'Do not fear and do not grieve but receive good tidings of Paradise.'",
      source: "Qur'an 41:30"
    },
...

  {
    ...
    description: [
      ...
      "When visiting, we greet the deceased with peace: 'Peace be upon you, O inhabitants of the graves, from among the believers and Muslims. We will surely join you. We ask Allah ﷻ for well-being for us and you.'",
      "We should make sincere prayers for the deceased, asking Allah ﷻ to forgive them and grant them mercy. Visiting should increase our own good deeds and remind us to prepare for death. We must not wail loudly or act disrespectfully."
    ],
    evidence: {
...

  {
    ...
    description: [
      "The Prophet Muhammad ﷺ taught us specific actions that protect from the grave's punishment. These include sincere faith in Allah ﷻ, dying as a martyr, dying on Friday, dying while guarding Islam's borders, and reciting Surah Al-Mulk regularly.",
      "Seeking refuge from the grave's punishment in every prayer is essential. We should say after every prayer: 'O Allah ﷻ, I seek refuge in You from the punishment of the grave and the trial of the Dajjal.'",
...

  {
    ...
    description: [
      "Those who die as martyrs fighting in Allah ﷻ's cause or defending Islam receive special honors. They do not experience the grave's trial or questioning. Their souls go directly to Paradise without waiting in Barzakh.",
      ...
      "Martyrs do not feel the pain of death except like a small pinch. Allah ﷻ forgives all their sins instantly when the first drop of blood is shed. They wish they could return to earth to be martyred again because of the tremendous honor."
    ],
    evidence: {
      arabic: "وَلَا تَحْسَبَنَّ الَّذِينَ قُتِلُوا فِي سَبِيلِ اللَّهِ أَمْوَاتًا ۚ بَلْ أَحْيَاءٌ عِندَ رَبِّهِمْ يُرْزَقُونَ",
      translation: "And do not think of those who have been killed in the cause of Allah ﷻ as dead. Rather, they are alive with their Lord, receiving provision.",
      source: "Qur'an 3:169"
    },
...

  {
    ...
    description: [
      "Although the grave's punishment is real and frightening, Allah ﷻ's mercy is greater than His punishment. Sincere repentance before death erases sins completely. Even major sinners who died believing will eventually enter Paradise after purification.",
      "Reflecting on death and the grave should motivate us toward good deeds, not paralyze us with fear. We balance hope in Allah ﷻ's mercy with fear of His punishment. This balance keeps us striving to improve constantly.",
    ...
    evidence: {
      ...
      translation: "Say, 'O My servants who have transgressed against themselves, do not despair of the mercy of Allah ﷻ. Indeed, Allah ﷻ forgives all sins.'",
      source: "Qur'an 39:53"
    },
    keyLesson: "We balance fear of the grave with hope in Allah ﷻ's infinite mercy, using both to motivate righteous living.",
    quizId: 12
  }
];

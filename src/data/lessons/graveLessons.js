...
const graveLessons = [
...

  {
    ...
    description: [
      ...
      "Some people are punished for specific sins like backbiting, lying, not cleaning properly after using the bathroom, or abandoning prayer. The Prophet Muhammad saw some of these punishments during his night journey and warned us about them.",
...

  {
    ...
    description: [
      "Visiting graves reminds us of death and the Hereafter, softening our hearts and reducing attachment to worldly things. The Prophet Muhammad encouraged visiting graves to remember our inevitable end and prepare for it.",
...

  {
    ...
    description: [
      "The Prophet Muhammad taught us specific actions that protect from the grave's punishment. These include sincere faith in Allah, dying as a martyr, dying on Friday, dying while guarding Islam's borders, and reciting Surah Al-Mulk regularly.",

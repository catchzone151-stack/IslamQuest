...
const judgementLessons = [
...

  {
    ...
    description: [
      "People will stand before Allah for a period lasting fifty thousand years according to our time. The length each person stands depends on their deeds—believers pass quickly while wrongdoers suffer longer in terrible anxiety and fear.",
...

  {
    ...
    description: [
      "When people can no longer bear the intense heat and long standing, they will desperately search for someone to intercede with Allah to begin the judgment. They will approach Adam, then Noah, then Abraham, then Moses, then Jesus—but each will direct them to another.",
      "Finally, people will come to Prophet Muhammad ﷺ, and he will accept, saying 'I am the one for this.' He will prostrate under Allah's Throne and praise Allah with words never spoken before. Allah will grant him permission to intercede for his Ummah.",
      "The Prophet ﷺ will intercede multiple times: first to begin the judgment, then to admit people into Paradise, then for those whose good and bad deeds are equal, and finally to remove believers from Hellfire. His intercession will save countless people through Allah's mercy."
    ],
    evidence: {
...

  {
    ...
    description: [
      ...
      "Only the Prophet's ﷺ true followers will be allowed to drink from it. Those who changed the religion or abandoned Islamic practices after him will be driven away. The Prophet will watch sadly as some who claimed to follow him are blocked from drinking."
    ],
    evidence: {
...

  {
    ...
    description: [
      "Paradise is the eternal home of peace, joy, and unimaginable beauty for those who believed in Allah and did good deeds. Its delights are beyond human imagination—whatever the heart desires and pleases the eye will be granted instantly without effort or delay.",

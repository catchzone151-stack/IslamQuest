export const paradiseLessons = [
  ...
  },
  {
    ...
    quizId: 2,
    description: [
      "Paradise has many beautiful Qur'anic names revealing different blessings. Jannah means 'garden.' Dar As-Salām means 'Abode of Peace' where no conflict or sadness exists.",
    ...
    evidence: {
      ...
      translation: "For them will be the Home of Peace (Dar As-Salām) with their Lord. (Qur'an 6:127)",
      source: "Qur'an 6:127"
    },
  ...
  },
  {
    ...
    description: [
      ...
      "The gates are extremely wide—the distance between sides equals the distance between Mecca and Busra. This immense width shows how welcoming Paradise is to believers.",
    ...
    evidence: {
      arabic: "وَسِيقَ الَّذِينَ اتَّقَوْا رَبَّهُمْ إِلَى الْجَنَّةِ زُمَرًا ۖ حَتَّىٰ إِذَا جَاءُوهَا وَفُتِحَتْ أَبْوَابُهَا",
  ...
  },
  {
    ...
    quizId: 5,
    description: [
      "The key to Paradise is saying 'Lā ilāha illā Allāh' with sincere belief and living according to its meaning through righteous actions proving our sincerity.",
      
      "Saying the words alone is not enough. The key needs the right 'teeth'—actions demonstrating true belief like prayer, charity, fasting, and avoiding major sins.",
      
      "The Prophet ﷺ taught that whoever dies with sincere Tawheed will eventually enter Paradise. Holding firmly to faith is essential salvation's foundation without which deeds are worthless."
    ],
    evidence: {
  ...
  },
  {
    ...
    evidence: {
      arabic: "إِنَّ أَدْنَى أَهْلِ الْجَنَّةِ مَنْزِلَةً لَرَجُلٌ يَنْظُرُ إِلَى جِنَانِهِ وَأَزْوَاجِهِ وَخَدَمِهِ وَسُرُرِهِ مَسِيرَةَ أَلْفِ سَنَةٍ",
  ...
  },
  {
    ...
    evidence: {
      arabic: "فِيهَا أَنْهَارٌ مِّن مَّاءٍ غَيْرِ آسِنٍ وَأَنْهَارٌ مِّن لَّبَنٍ لَّمْ يَتَغَيَّرْ طَعْمُهُ وَأَنْهَارٌ مِّنْ خَمْرٍ لَّذَّةٍ لِّلشَّارِبِينَ وَأَنْهَارٌ مِّنْ عَسَلٍ مُّصَفًّى",
  ...
  },
  {
    ...
    evidence: {
      arabic: "عَالِيَهُمْ ثِيَابُ سُندُسٍ خُضْرٌ وَإِسْتَبْرَقٌ ۖ وَحُلُّوا أَسَاوِرَ مِن فِضَّةٍ",
  ...
  },
  {
    ...
    evidence: {
      arabic: "وَالَّذِينَ آمَنُوا وَاتَّبَعَتْهُمْ ذُرِّيَّتُهُم بِإِيمَانٍ أَلْحَقْنَا بِهِمْ ذُرِّيَّتَهُمْ",
  ...
  },
  {
    ...
    evidence: {
      arabic: "إِنَّ فِي الْجَنَّةِ لَسُوقًا يَأْتُونَهَا كُلَّ جُمُعَةٍ",
  ...
  },
  {
    ...
    evidence: {
      arabic: "يَدْخُلُ أَهْلُ الْجَنَّةِ الْجَنَّةَ جُرْدًا مُرْدًا مُكَحَّلِينَ أَبْنَاءَ ثَلَاثِينَ أَوْ ثَلَاثٍ وَثَلَاثِينَ سَنَةً",

...
const openTerms = async () => {
  await Browser.open({ url: "https://catchzone151-stack.github.io/islamquest-privacy/terms.html" });
};

const openPrivacy = async () => {
  await Browser.open({ url: "https://catchzone151-stack.github.io/islamquest-privacy/privacy.html" });
};

...
export const useChallengeStore = create((set, get) => ({
  ...
  getFallbackQuestions: () => {
    return [
      { question: "What is the first pillar of Islam?", options: ["Prayer to Allah", "Shahada testimony", "Fasting in Ramadan", "Charity to poor"], answer: 1, difficulty: "medium" },
      { question: "How many daily prayers are obligatory in Islam?", options: ["The number 3 here", "The number 4 here", "The number 5 here", "The number 6 here"], answer: 2, difficulty: "easy" },
      { question: "Which prophet built the Kaaba?", options: ["Muhammad truly", "Ibrahim truly", "Musa truly here", "Isa truly here"], answer: 1, difficulty: "medium" },
      { question: "What is the holy book of Islam?", options: ["The Torah here", "The Bible here", "The Qur'an here", "The Vedas here"], answer: 2, difficulty: "easy" },
      { question: "In which month do Muslims fast?", options: ["Month of Rajab", "Month of Shaban", "Month of Ramadan", "Dhul Hijjah month"], answer: 2, difficulty: "easy" },
      { question: "What is Zakat?", options: ["Fasting practice", "Prayer practice", "Charity practice", "Pilgrimage duty"], answer: 2, difficulty: "easy" },
      { question: "Where is the Kaaba located?", options: ["City of Medina", "City of Mecca", "City of Jerusalem", "City of Cairo"], answer: 1, difficulty: "easy" },
      { question: "What does 'Islam' mean?", options: ["Peace to Allah", "Submission to Allah", "Peace & submission", "Faith in Allah"], answer: 2, difficulty: "medium" },
      { question: "Who was the first person to accept Islam?", options: ["Abu Bakr truly", "Khadijah truly", "Ali ibn Abi Talib", "Umar ibn Khattab"], answer: 1, difficulty: "medium" },
      { question: "How many verses are in Surah Al-Fatiha?", options: ["The number 5 here", "The number 6 here", "The number 7 here", "The number 8 here"], answer: 2, difficulty: "medium" },
      { question: "What is the meaning of 'Bismillah'?", options: ["In Allah's name", "Praise be to Allah", "Allah is Greatest", "No god but Allah"], answer: 0, difficulty: "easy" },
      { question: "Which direction do Muslims face when praying?", options: ["Direction East", "Direction West", "Towards Mecca here", "Direction North"], answer: 2, difficulty: "easy" },
      { question: "How many surahs are in the Qur'an?", options: ["The number 100", "The number 114", "The number 120", "The number 99"], answer: 1, difficulty: "medium" },
      { question: "What is the last pillar of Islam?", options: ["Shahada pillar", "Prayer pillar here", "Zakat pillar here", "Hajj pillar here"], answer: 3, difficulty: "medium" },
      { question: "Who was the last prophet in Islam?", options: ["Isa the prophet", "Musa the prophet", "Muhammad prophet", "Ibrahim prophet"], answer: 2, difficulty: "easy" },
      { question: "What is the night journey of Prophet Muhammad ﷺ called?", options: ["The Hijra here", "Isra and Mi'raj", "Battle of Badr", "Battle of Uhud"], answer: 1, difficulty: "medium" },
      { question: "How many times is 'Allahu Akbar' said in the Adhan?", options: ["The number 2 here", "The number 4 here", "The number 6 here", "The number 8 here"], answer: 1, difficulty: "hard" },
      { question: "What was the first word revealed to Prophet Muhammad ﷺ?", options: ["The word Say", "The word Read", "The word Pray", "The word Believe"], answer: 1, difficulty: "medium" },
      { question: "Which angel brought revelations to Prophet Muhammad ﷺ?", options: ["Mikael the angel", "Israfil the angel", "Jibreel the angel", "Azrael the angel"], answer: 2, difficulty: "easy" },
      { question: "What is the name of the well in Mecca near the Kaaba?", options: ["Well of Zamzam", "Place of Safa", "Place of Marwa", "Place of Arafat"], answer: 0, difficulty: "medium" },
      { question: "How many prophets are mentioned by name in the Qur'an?", options: ["The number 15", "The number 20", "The number 25", "The number 30"], answer: 2, difficulty: "hard" },
      { question: "What is the shortest surah in the Qur'an?", options: ["Surah Al-Fatiha", "Surah Al-Ikhlas", "Surah Al-Kawthar", "Surah An-Nas here"], answer: 2, difficulty: "hard" },
      { question: "In which city was Prophet Muhammad ﷺ born?", options: ["City of Medina", "City of Mecca", "City of Jerusalem", "City of Taif"], answer: 1, difficulty: "easy" },
      { question: "What is the Friday prayer called?", options: ["Fajr prayer here", "Jumu'ah prayer", "Isha prayer here", "Maghrib prayer"], answer: 1, difficulty: "easy" },
      { question: "How many rakats are in Fajr prayer?", options: ["The number 2 here", "The number 3 here", "The number 4 here", "The number 5 here"], answer: 0, difficulty: "medium" },
      { question: "What is the blessed night in Ramadan called?", options: ["Laylat al-Qadr", "Night of Journey", "Night of Destiny", "Night of Blessing"], answer: 0, difficulty: "medium" },
      { question: "Who was the mother of Prophet Ismail عليه السلام?", options: ["Sarah the mother", "Hajar the mother", "Maryam the mother", "Asiyah the mother"], answer: 1, difficulty: "medium" },
      { question: "What is the first month of the Islamic calendar?", options: ["Month of Ramadan", "Month of Muharram", "Month of Rajab", "Month of Shawwal"], answer: 1, difficulty: "medium" },
      { question: "How many years did Prophet Muhammad ﷺ receive revelations?", options: ["For 10 yrs total", "For 15 yrs total", "For 23 yrs total", "For 30 yrs total"], answer: 2, difficulty: "hard" },
      { question: "What is the Arabic word for fasting?", options: ["Salah in Arabic", "Sawm in Arabic", "Zakat in Arabic", "Hajj in Arabic"], answer: 1, difficulty: "easy" },
      { question: "Which prophet is known as 'Khalilullah' (Friend of Allah)?", options: ["Musa the prophet", "Isa the prophet", "Ibrahim prophet", "Nuh the prophet"], answer: 2, difficulty: "medium" },
      { question: "What are the two main celebrations in Islam?", options: ["Eid Fitr & Adha", "Eid Fitr & Mawlid", "Eid Adha & Ashura", "Mawlid and Ashura"], answer: 0, difficulty: "easy" },
      { question: "What is the name of the treaty signed between Muslims and Quraysh?", options: ["Treaty of Medina", "Hudaybiyyah treaty", "Treaty of Aqaba", "Treaty of Taif"], answer: 1, difficulty: "hard" },
      { question: "Which surah is known as 'the heart of the Qur'an'?", options: ["Surah Al-Baqarah", "Surah Ya-Sin here", "Surah Al-Rahman", "Surah Al-Mulk"], answer: 1, difficulty: "hard" },
      { question: "How many times should a Muslim perform Hajj in their lifetime?", options: ["Once in lifetime", "Twice in lifetime", "Three times total", "Every year truly"], answer: 0, difficulty: "easy" },
      { question: "What is the meaning of 'Alhamdulillah'?", options: ["God is Greatest", "In God's name here", "All praise to Allah", "God willing truly"], answer: 2, difficulty: "easy" },
      { question: "Which companion was known as 'As-Siddiq' (The Truthful)?", options: ["Umar ibn Khattab", "Abu Bakr truly", "Uthman ibn Affan", "Ali ibn Abi Talib"], answer: 1, difficulty: "medium" },
      { question: "What is the prayer before dawn called?", options: ["Fajr prayer here", "Zuhr prayer here", "Asr prayer here", "Isha prayer here"], answer: 0, difficulty: "easy" },
      { question: "What is the Arabic term for supplication?", options: ["Salah in Arabic", "Dua in Arabic", "Dhikr in Arabic", "Tasbih in Arabic"], answer: 1, difficulty: "easy" },
      { question: "Which prophet was swallowed by a whale?", options: ["Musa the prophet", "Yunus the prophet", "Nuh the prophet", "Ayyub the prophet"], answer: 1, difficulty: "easy" },
      { question: "What is the meaning of 'SubhanAllah'?", options: ["All praise to Allah", "Glory be to Allah", "Allah is Greatest", "In Allah's name"], answer: 1, difficulty: "easy" },
      { question: "How many rakats are in Isha prayer?", options: ["The number 2 here", "The number 3 here", "The number 4 here", "The number 5 here"], answer: 2, difficulty: "medium" },
      { question: "Which prophet was known for his patience?", options: ["Yusuf the prophet", "Ayyub the prophet", "Dawud the prophet", "Sulaiman prophet"], answer: 1, difficulty: "medium" },
      { question: "What is the name of Prophet Muhammad's ﷺ grandfather?", options: ["Abu Talib truly", "Abdul Muttalib", "Abu Lahab truly", "Hashim ibn Abdul"], answer: 1, difficulty: "medium" },
      { question: "Which surah mentions the story of Yusuf عليه السلام?", options: ["Surah Yusuf here", "Surah Maryam here", "Surah Al-Kahf", "Surah Al-Anbiya"], answer: 0, difficulty: "easy" },
      { question: "What is the meaning of 'La ilaha illallah'?", options: ["God is Greatest", "No god but Allah", "All praise to Allah", "In Allah's name"], answer: 1, difficulty: "easy" },
      { question: "How many gates does Jannah have?", options: ["The number 4 here", "The number 7 here", "The number 8 here", "The number 12"], answer: 2, difficulty: "hard" },
      { question: "Which prophet could speak to animals?", options: ["Dawud the prophet", "Sulaiman prophet", "Musa the prophet", "Isa the prophet"], answer: 1, difficulty: "medium" },
      { question: "What is the Arabic word for prayer?", options: ["Sawm in Arabic", "Salah in Arabic", "Zakat in Arabic", "Hajj in Arabic"], answer: 1, difficulty: "easy" },
      { question: "Which companion was known as 'Al-Farooq'?", options: ["Abu Bakr truly", "Umar ibn Khattab", "Uthman ibn Affan", "Ali ibn Abi Talib"], answer: 1, difficulty: "medium" },
      { question: "What is the last surah of the Qur'an?", options: ["Surah Al-Fatiha", "Surah Al-Ikhlas", "Surah An-Nas here", "Surah Al-Falaq"], answer: 2, difficulty: "easy" },
      { question: "How many rakats are in Zuhr prayer?", options: ["The number 2 here", "The number 3 here", "The number 4 here", "The number 5 here"], answer: 2, difficulty: "medium" },
      { question: "Which prophet was given the Zabur (Psalms)?", options: ["Musa the prophet", "Dawud the prophet", "Isa the prophet", "Ibrahim prophet"], answer: 1, difficulty: "medium" },
      { question: "What is the meaning of 'insha'Allah'?", options: ["God willing truly", "God is Greatest", "Praise be to God", "In God's name here"], answer: 0, difficulty: "easy" },
      { question: "Which prophet is known as 'Ruhullah' (Spirit of Allah)?", options: ["Ibrahim prophet", "Musa the prophet", "Isa the prophet", "Adam the prophet"], answer: 2, difficulty: "hard" },
      { question: "What is the name of the angel of death?", options: ["Jibreel the angel", "Mikael the angel", "Israfil the angel", "Azrael the angel"], answer: 3, difficulty: "medium" },
      { question: "How many prophets are considered 'Ulul Azm' (resolute)?", options: ["The number 3 here", "The number 4 here", "The number 5 here", "The number 6 here"], answer: 2, difficulty: "hard" },
      { question: "Which surah is also called 'Al-Hamd'?", options: ["Surah Al-Baqarah", "Surah Al-Fatiha", "Surah Al-Ikhlas", "Surah Ya-Sin here"], answer: 1, difficulty: "medium" },
      { question: "What is the Arabic word for pilgrimage?", options: ["Sawm in Arabic", "Salah in Arabic", "Zakat in Arabic", "Hajj in Arabic"], answer: 3, difficulty: "easy" },
      { question: "Which prophet built the Ark?", options: ["Ibrahim prophet", "Musa the prophet", "Nuh the prophet", "Isa the prophet"], answer: 2, difficulty: "easy" }
    ];
  },
